...
with Visual Basic.
The example code consists of a simple dialog form and a standard module
containing the interface code to call unzip32.dll.
...
unzip32.dll in the directory where the VB executable is stored.
