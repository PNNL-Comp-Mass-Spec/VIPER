...
On Error GoTo CopyAllUMCsInViewErrorHandler
    ...
    For lngUMCIndex = 0 To lngUMCsInViewCount - 1
        ...
        If lngPairMatchCount > 0 Then
            For lngPairMatchIndex = 0 To lngPairMatchCount - 1
                ...
                With udtPairMatchStats(lngPairMatchIndex)
                    ...
                    CopyAllUMCsInViewAppendLine strLineOut & strLineOutMiddle & strLineOutEnd & strLineOutEndAddnl, strExport(), strFilePath, OutFileNum, lngExportCount, lngExportCountDimmed
                End With
        ...
        Else
            ...
            strLineOut = strLineOut & strLineOutMiddle & strLineOutEnd & strLineOutEndAddnl
