...
Begin VB.Form frmEditAnalysisSettings 
   ...
   Begin TabDlg.SSTab tbsTabStrip 
      ...
      Tab(5).Control(0)=   "fraToleranceRefinementPeakCriteria"
      Tab(5).Control(1)=   "fraOptionFrame(2)"
      Tab(5).Control(2)=   "fraOptionFrame(3)"
      Tab(5).Control(3)=   "fraOptionFrame(0)"
      Tab(5).Control(4)=   "fraOptionFrame(1)"
      Tab(5).Control(5)=   "lblMassCalibrationRefinementDescription"
      Tab(5).Control(6)=   "lblToleranceRefinementExplanation"
      ...
      Begin VB.CheckBox chkSkipFindUMCs 
         Caption         =   "Skip Finding UMCs (only appropriate if auto-processing .Gel files)"
         Height          =   255
         Left            =   -74760
         TabIndex        =   68
         Top             =   520
      ...
      Begin VB.Frame fraOptionFrame 
         ...
         Begin VB.CheckBox chkSaveUMCStatisticsToTextFile 
            Caption         =   "Save all UMC's to text file (not just those with database matches)"
            Height          =   375
            Left            =   240
            TabIndex        =   520
      ...
      Begin VB.Frame fraOptionFrame 
         ...
         End
         Begin VB.Label lblDescription 
            Caption         =   "UMC's to use for NET adjustment"
            Height          =   255
            Index           =   102
            Left            =   120
            TabIndex        =   266
      ...
      Begin VB.Frame fraNETIterationOptions 
         ...
         End
         Begin VB.Label lblDescription 
            Caption         =   "UMC's top percent increment"
            Height          =   255
            Index           =   95
            Left            =   360
            TabIndex        =   322
      ...
      Begin VB.Frame fraNETIterationOptions 
         ...
         Begin VB.CheckBox chkUMCUseTopAbu 
            Caption         =   "Use high-abundance UMCs only - (Top Abu %)"
            Height          =   375
            Left            =   240
            TabIndex        =   295
            Top             =   1155
         ...
         End
         Begin VB.Label lblDescription 
            Caption         =   "Minimum number of peaks in UMC"
            Height          =   255
            Index           =   53
            Left            =   240
            TabIndex        =   289
      ...
      Begin VB.Frame fraOptionFrame 
         ...
         Begin VB.CheckBox chkRefineDBSearchMassTolerance 
            Caption         =   "Refine DB mass search tolerance using mass error plot"
            Height          =   255
            Left            =   240
            TabIndex        =   442
            Top             =   360
         ...
         End
         Begin VB.Label lblDescription 
            Caption         =   "Adjustment multiplier (all except FWHM adj.)"
            Height          =   255
            Index           =   94
            Left            =   240
            TabIndex        =   449
      ...
      Begin VB.Frame fraOptionFrame 
         ...
         Begin VB.CheckBox chkRefineDBSearchNETTolerance 
            Caption         =   "Refine DB NET search tolerance using GANET error plot"
            Height          =   255
            Left            =   240
            TabIndex        =   453
            Top             =   360
      ...
      Begin VB.Frame fraOptionFrame 
         ...
         Begin VB.ComboBox cboSearchRegionShape 
            ...
            Width           =   2775
         End
         Begin VB.TextBox txtRefineDBSearchMaximumAbundance 
            Alignment       =   1  'Right Justify
            Height          =   285
            Left            =   4200
            Locked          =   -1  'True
            ...
            Width           =   615
         End
         Begin VB.TextBox txtRefineDBSearchMinimumSLiC 
            Alignment       =   1  'Right Justify
            Height          =   285
            Left            =   4200
            Locked          =   -1  'True
         ...
         Begin VB.CheckBox chkUseUMCClassStats 
            ...
            Width           =   2500
         End
         Begin VB.TextBox txtToleranceRefinementMinimumHighDiscriminantScore 
            Alignment       =   1  'Right Justify
            Height          =   285
            Left            =   1680
            TabIndex        =   415
         ...
         Begin VB.CheckBox chkRefineDBSearchIncludeInternalStds 
            ...
            Width           =   2775
         End
         Begin VB.TextBox txtToleranceRefinementMinimumHighNormalizedScore 
            Alignment       =   1  'Right Justify
            Height          =   285
            Left            =   1680
            TabIndex        =   413
      ...
      Begin VB.Frame fraOptionFrame 
         ...
         Begin VB.CheckBox chkExportUMCsWithNoMatches 
            Caption         =   "Export UMC's with no database matches"
            Height          =   255
            Left            =   360
            TabIndex        =   526
            Top             =   820
      ...
      Begin VB.Frame fraOptionFrame 
         ...
         Begin VB.CheckBox chkSaveErrorGraphic3D 
            Caption         =   "Save 3D error plot (Mass vs. GANET)"
            Height          =   255
            Left            =   240
            TabIndex        =   543
            Top             =   600
      ...
      Begin VB.Frame fraOptionFrame 
         ...
         Begin VB.CheckBox chkExtendedFileSaveModePreferred 
            Caption         =   "Include UMC's with the raw data when saving"
            Height          =   255
            Left            =   600
            TabIndex        =   531
            Top             =   510
      ...
      Begin VB.Frame fraUMCIonNetOptions 
         Caption         =   "UMC Ion Network Options"
         Height          =   4095
         Left            =   -74760
         TabIndex        =   104
         Top             =   3360
      ...
      End
      Begin VB.Frame fraOptionFrame 
         Caption         =   "Scan Range and GANET Range"
         Height          =   1935
         Index           =   6
         Left            =   -74760
         TabIndex        =   27
         ...
         Begin VB.CheckBox chkRestrictGANETRange 
            Caption         =   "Use only scans whose GANET value is within range"
            Height          =   615
            Left            =   120
            TabIndex        =   33
            Top             =   1080
      ...
      Begin VB.CheckBox chkSkipGANETSlopeAndInterceptComputation 
         Caption         =   "Skip GANET Slope and Intercept Computation"
         Height          =   255
         Left            =   -74760
         TabIndex        =   287
         Top             =   480
...
On Error GoTo DisplayCurrentAnalysisSettingsErrorHandler
    ...
    With mCurrentSettings
        ...
        With .PrefsExpanded.RefineMSDataOptions
            ...
            txtRefineDBSearchMinimumSLiC = Trim(.MinimumSLiC)
            txtRefineDBSearchMaximumAbundance = Trim(.MaximumAbundance)
        End With
        ...
        With .PrefsExpanded.AutoAnalysisOptions
            ...
            With .AutoToleranceRefinement
                ...
                txtToleranceRefinementMinimumHighNormalizedScore = .DBSearchMinimumHighNormalizedScore
                txtToleranceRefinementMinimumHighDiscriminantScore = .DBSearchMinimumHighDiscriminantScore
...
Private Sub DisplayCurrentDBSettings()
    ...
    With mCurrentSettings.DBSettings
        If Not .IsDeleted Then
            ...
            txtMinimumHighNormalizedScore = .MinimumHighNormalizedScore
            txtMinimumHighDiscriminantScore = .MinimumHighDiscriminantScore
...
Private Sub PopulateComboBoxes()
    ...
    With cboDBSearchMode
        .Clear
        .AddItem "Export UMC's Only (No DB Search)", dbsmExportUMCsOnly
        .AddItem "Individual peaks", dbsmIndividualPeaks
        .AddItem "Individual peaks in UMC's without NET", dbsmIndividualPeaksInUMCsWithoutNET
        .AddItem "Peaks in UMC's with NET (not supported)", dbsmIndividualPeaksInUMCsWithNET
        .AddItem "Conglomerate UMC masses with NET (preferred)", dbsmConglomerateUMCsWithNET
        .AddItem "Peaks in UMC's with NET, paired (not supported)", dbsmIndividualPeaksInUMCsPaired
        .AddItem "Peaks in UMC's with NET, unpaired (not supported)", dbsmIndividualPeaksInUMCsUnpaired
        .AddItem "Conglomerate UMC masses - Paired Only", dbsmConglomerateUMCsPaired
        .AddItem "Conglomerate UMC masses - Unpaired Only", dbsmConglomerateUMCsUnpaired
        .AddItem "N14/N15 pairs (individual UMC peaks, not supported)", dbsmPairsN14N15
        .AddItem "N14/N15 pairs (conglomerate UMC masses)", dbsmPairsN14N15ConglomerateMass
        .AddItem "ICAT pairs (individual peaks in UMC's)", dbsmPairsICAT
        .AddItem "PEO pairs (individual peaks in UMC's)", dbsmPairsPEO
        .AddItem "Congolmerate UMC masses - Light Pairs Plus Unpaired", dbsmConglomerateUMCsLightPairsPlusUnpaired
    ...
    With cboPairsUMCsToUseForNETAdjustment
        ...
        .AddItem "Unpaired UMC's plus light members of paired UMC's", punaUnpairedPlusPairedLight
...
Private Sub UpdateDBSearchModeTooltip()
    ...
    Case dbsmExportUMCsOnly: strToolTip = "Exports all UMC's to the database without actually searching for MT tag hits"
    Case dbsmIndividualPeaks: strToolTip = "Searches DB using individual peaks (ions); does not use UMC's"
    Case dbsmIndividualPeaksInUMCsWithoutNET: strToolTip = "Searches DB using each peak in each UMC; uses mass, but not NET"
    Case dbsmIndividualPeaksInUMCsWithNET: strToolTip = "This search mode is no longer supported"
    Case dbsmConglomerateUMCsWithNET: strToolTip = "Searches DB using the class mass for each UMC (1 search per UMC); uses class mass and NET of class representative"
    ...
    Case dbsmConglomerateUMCsPaired: strToolTip = "Searches DB using using the class mass for each paired UMC, using either the light or heavy member (specify below)"
    Case dbsmConglomerateUMCsUnpaired: strToolTip = "Searches DB using using the class mass for each unpaired UMC"
    Case dbsmConglomerateUMCsLightPairsPlusUnpaired: strToolTip = "Searches DB using the class mass of the light member of each paired UMC, plus the masses of the unpaired UMCs"
    Case dbsmPairsN14N15: strToolTip = "This search mode is no longer supported"
    Case dbsmPairsN14N15ConglomerateMass: strToolTip = "Searches DB using the class mass of each paired UMC, light members only; uses mass and NET, plus considers number of N atoms"
    Case dbsmPairsICAT: strToolTip = "Searches DB using each peak in each paired UMC, light members only; uses mass and NET, plus considers number of Cys residues"
    Case dbsmPairsPEO: strToolTip = "Searches DB using each peak in each paired UMC, light members only; uses mass and NET, plus considers number of N atoms and number of Cys residues"
    Case Else
        ' This shouldn't happen
        Debug.Assert False
        strToolTip = ""
...
On Error GoTo UpdateDynamicControlsErrorHandler
    ...
    If mCurrentSettings.PrefsExpanded.UMCAutoRefineOptions.TestLengthUsingScanRange Then
        chkAutoRefineCheckbox(uarRemoveShort).Caption = "Remove classes less than"
        chkAutoRefineCheckbox(uarRemoveLong).Caption = "Remove classes more than"
...
Private Sub cboMassToleranceRefinementMethod_Click()
    mCurrentSettings.PrefsExpanded.RefineMSDataOptions.MassToleranceRefinementMethod = cboMassToleranceRefinementMethod.ListIndex
End Sub
...
Private Sub txtRefineDBSearchMaximumAbundance_LostFocus()
    ValidateTextboxValueDbl txtRefineDBSearchMaximumAbundance, 0, 1E+300, 0
    mCurrentSettings.PrefsExpanded.RefineMSDataOptions.MaximumAbundance = CDblSafe(txtRefineDBSearchMaximumAbundance)
End Sub

Private Sub txtRefineDBSearchMinimumSLiC_LostFocus()
    ValidateTextboxValueDbl txtRefineDBSearchMinimumSLiC, 0, 1, 0
    mCurrentSettings.PrefsExpanded.RefineMSDataOptions.MinimumSLiC = CSngSafe(txtRefineDBSearchMinimumSLiC)
End Sub
...
Private Sub txtRefineDBSearchNETToleranceMaximum_LostFocus()
    ...
    End If
    mCurrentSettings.PrefsExpanded.RefineMSDataOptions.NETToleranceMaximum = CDblSafe(txtRefineDBSearchNETToleranceMaximum)
End Sub
...
Private Sub txtRefineDBSearchNETToleranceMinimum_LostFocus()
    ...
    End If
    mCurrentSettings.PrefsExpanded.RefineMSDataOptions.NETToleranceMinimum = CDblSafe(txtRefineDBSearchNETToleranceMinimum)
End Sub
...
Private Sub txtToleranceRefinementMinimumHighDiscriminantScore_LostFocus()
    ValidateTextboxValueDbl txtToleranceRefinementMinimumHighDiscriminantScore, 0, 1, 0.5
    mCurrentSettings.PrefsExpanded.AutoAnalysisOptions.AutoToleranceRefinement.DBSearchMinimumHighDiscriminantScore = CSngSafe(txtToleranceRefinementMinimumHighDiscriminantScore)
End Sub

Private Sub txtToleranceRefinementMinimumHighNormalizedScore_LostFocus()
    ValidateTextboxValueDbl txtToleranceRefinementMinimumHighNormalizedScore, 0, 100000, 2.5
    mCurrentSettings.PrefsExpanded.AutoAnalysisOptions.AutoToleranceRefinement.DBSearchMinimumHighNormalizedScore = CSngSafe(txtToleranceRefinementMinimumHighNormalizedScore)
End Sub
