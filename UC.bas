...
Public Type UMCDefinition2002
    ...
    DefScope As Integer
    MWField As Integer                      'mass type (mftMWAvg or mftMWMono or mftMWTMA)
...
With GelUMC(Ind)
  If .UMCCnt > 0 Then
     ...
     ISF = .def.MWField
     If ISF <> mftMWAvg And ISF <> mftMWMono And ISF <> mftMWTMA Then
        Debug.Assert False
        ISF = mftMWMono
     End If
...
If GelUMC(lngGelIndex).UMCCnt > 0 Then
   ...
   If lRows > 0 Then
      ...
      sLine = "UMC_ID" & glARG_SEP & _
              ...
              "Scan2" & glARG_SEP & _
              "UMC_Abu" & glARG_SEP & _
              "UMC_Avg_Fit" & glARG_SEP & _
              "Rep_Scan" & glARG_SEP & _
              "Rep_CS" & glARG_SEP & _
              "Rep_MW" & glARG_SEP & _
              "Rep_m/z" & glARG_SEP & _
              "Rep_Abu"
