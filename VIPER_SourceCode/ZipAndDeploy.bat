...
Set InstallerFolder=%ProgramName%_Installer\Output\DISK_1
...
"c:\program files (x86)\winrar\winRar.exe" a -ep %SourceAndSupportingDLLsFile% ..\ReadMe.txt
"c:\program files (x86)\winrar\winRar.exe" a -ep %SourceAndSupportingDLLsFile% ..\RevisionHistory.txt
...
"c:\program files (x86)\winrar\winRar.exe" a -ep %ZippedInstallerFile% ..\%InstallerFolder%\*.msi ..\%InstallerFolder%\*.cab
"c:\program files (x86)\winrar\winRar.exe" a -ep %ZippedInstallerFile% "LCMSFeatureFinder (Install this after installing Viper).msi"
"c:\program files (x86)\winrar\winRar.exe" a -ep %ZippedInstallerFile% ..\ReadMe.txt
"c:\program files (x86)\winrar\winRar.exe" a -ep %ZippedInstallerFile% ..\RevisionHistory.txt
