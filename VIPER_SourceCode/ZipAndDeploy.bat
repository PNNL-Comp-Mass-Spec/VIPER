...
"c:\program files\winrar\winRar.exe" a -ep %ZippedInstallerFile% ..\%InstallerFolder%\*.msi ..\%InstallerFolder%\*.cab
"c:\program files\winrar\winRar.exe" a -ep %ZippedInstallerFile% "LCMSFeatureFinder (Install this after installing Viper).msi"
