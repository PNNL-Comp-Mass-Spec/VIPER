...
Case -2
   ...
   txtNETFormula.SetFocus
Case -3
   MsgBox "No pairs found. Make sure that some of UMC pairing functions was applied first.", vbOKOnly, glFGTU
Case -4
...
Case Else
   MsgBox "MT tag hits: " & HitsCnt & "(non-unique)", vbOKOnly, glFGTU
    ...
    AddToAnalysisHistory CallerID, GetMassTagSearchSummaryText("Searched ICAT pairs for MT tags", HitsCnt, 0, 0, samtDef, True, GelData(CallerID).CustomNETsDefined)
End Select
...
ts.WriteLine "Reporting identification for ICAT UMC pairs"
